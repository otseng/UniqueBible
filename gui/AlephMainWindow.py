...
class AlephMainWindow(MainWindow):
    ...
    def create_menu(self):
        ...
        layoutMenu.addAction(
            QAction(config.thisTranslation["menu1_original_menu_layout"], self, triggered=self.setDefaultMenuLayout))
        layoutMenu.addAction(
        ...
        navigation_menu.addAction(QAction(config.thisTranslation["menu4_next"], self, shortcut='Ctrl+K', triggered=self.nextMainChapter))
        navigation_menu.addAction(QAction(config.thisTranslation["menu4_previous"], self, shortcut='Ctrl+J', triggered=self.previousMainChapter))
        ...
        history_menu.addAction(QAction(config.thisTranslation["menu3_main"], self, shortcut="Ctrl+H, M", triggered=self.mainHistoryButtonClicked))
        history_menu.addAction(QAction(config.thisTranslation["menu3_mainBack"], self, shortcut="Ctrl+H, 1", triggered=self.back))
        history_menu.addAction(QAction(config.thisTranslation["menu3_mainForward"], self, shortcut="Ctrl+H, 2", triggered=self.forward))
        history_menu.addAction(QAction(config.thisTranslation["menu3_study"], self, shortcut = 'Ctrl+H, S', triggered=self.studyHistoryButtonClicked))
        ...
        toolbar_menu.addAction(QAction(config.thisTranslation["menu2_left"], self, shortcut="Ctrl+T, 4", triggered=self.hideShowLeftToolBar))
        toolbar_menu.addAction(QAction(config.thisTranslation["menu2_right"], self, shortcut="Ctrl+T, 5", triggered=self.hideShowRightToolBar))
        display_menu.addSeparator()
        display_menu.addAction(QAction(config.thisTranslation["menu2_larger"], self, shortcut="Ctrl++", triggered=self.largerFont))
        display_menu.addAction(QAction(config.thisTranslation["menu2_smaller"], self, shortcut="Ctrl+-", triggered=self.smallerFont))
        ...
        about_menu.addAction(QAction(config.thisTranslation["menu9_donate"], self, triggered=self.donateToUs))
