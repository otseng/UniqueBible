...
class ClassicMainWindow:
    ...
    def create_menu(self):
        ...
        if (not self.isMyTranslationAvailable() and not self.isOfficialTranslationAvailable()) \
                or (self.isMyTranslationAvailable() and not myTranslation.translationLanguage == config.userLanguage) \
                or (self.isOfficialTranslationAvailable() and not config.translationLanguage == config.userLanguage):
