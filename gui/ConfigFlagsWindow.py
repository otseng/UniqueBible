...
class ConfigFlagsWindow(QDialog):
    ...
    def getOptions(self):
        options = [
            ...
            ("enableHttpRemoteErrorRedirection", config.enableHttpRemoteErrorRedirection, self.enableHttpRemoteErrorRedirection, True, config.thisTranslation["enableHttpRemoteErrorRedirection"]),
        ]
