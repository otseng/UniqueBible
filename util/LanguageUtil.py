...
if __name__ == "__main__":
    ...
    # createNewLanguageFile("ko")
    # updateLanguageFile("ko")
    # compareLanguageFiles("en_US", "ko")
    # createNewLanguageFile("es")
    # compareLanguageFiles("en_US", "es")
    # createNewLanguageFile("de")
    # compareLanguageFiles("en_GB", "de")
    # compareLanguageFiles("en_US", "de")
    # createNewLanguageFile("fr")
    # compareLanguageFiles("en_GB", "fr")
    # compareLanguageFiles("es", "fr")
    # compareLanguageFiles("ko", "fr")
    # createNewLanguageFile("it")
    compareLanguageFiles("en_US", "it")
    compareLanguageFiles("ko", "it")
